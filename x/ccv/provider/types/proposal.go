...
var (
	_ govtypesv1beta1.Content = &ConsumerAdditionProposal{}
	_ govtypesv1beta1.Content = &ConsumerRemovalProposal{}
	_ govtypesv1beta1.Content = &EquivocationProposal{}
)

func init() {
	govtypesv1beta1.RegisterProposalType(ProposalTypeConsumerAddition)
	govtypesv1beta1.RegisterProposalType(ProposalTypeConsumerRemoval)
	govtypesv1beta1.RegisterProposalType(ProposalTypeEquivocation)
}
...
func (cccp *ConsumerAdditionProposal) ValidateBasic() error {
	if err := govtypesv1beta1.ValidateAbstract(cccp); err != nil {
		return err
	}
...
func NewConsumerRemovalProposal(title, description, chainID string, stopTime time.Time) govtypesv1beta1.Content {
...
func (sccp *ConsumerRemovalProposal) ValidateBasic() error {
	if err := govtypesv1beta1.ValidateAbstract(sccp); err != nil {
		return err
	}
...
func NewEquivocationProposal(title, description string, equivocations []*evidencetypes.Equivocation) govtypesv1beta1.Content {
...
func (sp *EquivocationProposal) ValidateBasic() error {
	if err := govtypesv1beta1.ValidateAbstract(sp); err != nil {
		return err
	}
