...
$SOVEREIGN_BINARY genesis add-genesis-account $(jq -r .address $SOVEREIGN_HOME/consumer_keypair.json) 1000000000stake --home $SOVEREIGN_HOME
$SOVEREIGN_BINARY genesis add-genesis-account $(jq -r .address $SOVEREIGN_HOME/sovereign_validator_keypair.json) 1000000000000stake --home $SOVEREIGN_HOME

# generate genesis for sovereign chain
$SOVEREIGN_BINARY genesis gentx $SOVEREIGN_VALIDATOR 11000000000stake $KEYRING --chain-id=$CONSUMER_CHAIN_ID --home $SOVEREIGN_HOME
$SOVEREIGN_BINARY genesis collect-gentxs --home $SOVEREIGN_HOME
...
# $SOVEREIGN_BINARY tx gov submit-legacy-proposal software-upgrade "v07-Theta" --upgrade-height=26  \
...
--upgrade-height=26 \
--upgrade-info="file:///Users/admin/Documents/j121/stride/interchain-security/upgrade-info.json?checksum=sha256:da27b41da83d39ed22d5a01e2958765d6f05d51052e74244163303ec060d604d" \
--title="upgrade to consumer chain" --description="upgrade to consumer chain description" \
